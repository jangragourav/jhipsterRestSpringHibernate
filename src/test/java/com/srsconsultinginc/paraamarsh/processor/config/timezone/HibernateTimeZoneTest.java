package com.srsconsultinginc.paraamarsh.processor.config.timezone;

import com.srsconsultinginc.paraamarsh.processor.ProcessorApp;
import com.srsconsultinginc.paraamarsh.processor.repository.timezone.DateTimeWrapper;
import com.srsconsultinginc.paraamarsh.processor.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM processor_date_time_wrapper where id=%d", fieldName, id);
    }
